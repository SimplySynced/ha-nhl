...
class NHLScoresFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Config flow for NHL."""
    ...
    def async_get_options_flow(config_entry):
        return NHLScoresOptionsFlow(config_entry)


class NHLScoresOptionsFlow(config_entries.OptionsFlow):
    """Options flow for NHL."""
